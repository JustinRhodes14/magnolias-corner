            ...
            <Row>
                ...
                <Col>
                    <Parallax speed={7} easing={'easeOutQuad'}>
                        <Image src={art1} alt='Art Piece #1' width={'350px'} height={'350px'}/>
                    </Parallax>
                </Col>
                <Col/>
                <Col>
                    <Parallax speed={-10} easing={'easeOutQuad'}>
                        <Image src={art2} alt='Art Piece #2' width={'350px'} height={'350px'}/>
                    </Parallax>
                </Col>
                <Col/>
                <Col>
                    <Parallax speed={13} easing={'easeOutQuad'}>
                        <Image src={art3} alt='Art Piece #3' width={'350px'} height={'350px'}/>
                    </Parallax>
                </Col>
                <Col/>
            </Row>
            <Row>
                ...
                <Col >
                    <Parallax speed={14} easing={'easeOutQuad'}>
                        <Image src={art4} alt='Art Piece #4' width={'350px'} height={'350px'}/>
                    </Parallax>
                </Col>
                <Col />
                <Col >
                    <Parallax speed={3} easing={'easeOutQuad'}>
                        <Image src={art5} alt='Art Piece #5' width={'350px'} height={'350px'}/>
                    </Parallax>
                </Col>
                <Col />
            </Row>
            <Row>
                ...
                <Col >
                    <Parallax speed={11} easing={'easeOutQuad'}>
                        <Image src={art6} alt='Art Piece #6' width={'350px'} height={'350px'}/>
                    </Parallax>
                </Col>
                <Col />
                <Col >
                    <Parallax speed={-12} easing={'easeOutQuad'}>
                        <Image src={art7} alt='Art Piece #7' width={'350px'} height={'350px'}/>
                    </Parallax>
                </Col>
                <Col />
                <Col >
                    <Parallax speed={4} easing={'easeOutQuad'}>
                        <Image src={art8} alt='Art Piece #8' width={'350px'} height={'350px'}/>
                    </Parallax>
                </Col>
                <Col />
            </Row>
